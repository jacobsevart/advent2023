...
class ScratchCardsTest {
    ...
    public void testWinningNumbers() {
        assertEquals(8, ScratchCards.countWinning("Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53"));
        assertEquals(16, ScratchCards.countWinning("Card 1: 41 48 83 86 17  6 | 83 86  6 31 17  9 48 53"));
